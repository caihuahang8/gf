...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            console.log(vm.ziliao.url)
            var url = vm
                .ziliao.id ==
            null ? "../ziliao/save" : "../ziliao/update";
            $.ajax({
                type: "POST",
                url: url,
                data: JSON.stringify(vm.ziliao),
                success: function (r) {
                    if (r.code === 0) {
        ...
        download: function (id) {
            ...
            // });
            window.location.href="http://localhost:8080/gf_war/ziliao/download/"+ id
